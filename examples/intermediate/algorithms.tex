...
% \usepackage[ruled,vlined]{algorithm2e} % Commented out as not standard
\usepackage{listings}
\usepackage{xcolor}
...
\lstdefinestyle{pseudocode}{
    ...
    morekeywords={Input,Output,In,Out,SetAlgoLined,KwIn,KwOut,BlankLine,Repeat,For,If,swap},
    mathescape=true
}
...
\begin{lstlisting}[style=pseudocode,caption={Bubble Sort using Algorithm2e}]
Input: A : list of sortable items
